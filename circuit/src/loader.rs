        ...
        .filter_map(|d| match d {
            Draw::Pin(pin) => Some(Pin {
                ...
                pin_type: match pin.pin_type {
                    ...
                    KicadPinType::PowerOutput => PinType::PowerOutput,
                    KicadPinType::PowerInput => PinType::PowerInput,
                    KicadPinType::NotConnected => PinType::NotConnected,
                    KicadPinType::Tristate => PinType::TriState,
                    KicadPinType::Passive => PinType::Passive,
                    KicadPinType::Unspecified => PinType::Unknown,
                    KicadPinType::OpenCollector => PinType::OpenCollector,
                    KicadPinType::OpenEmitter => PinType::OpenEmitter,
                },
            }),
            _ => None,
        })
